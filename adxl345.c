...
static adxl345_err_t adxl345_bus_initialize(adxl345_t const* adxl345)
{
    return adxl345->interface.bus_initialize
               ? adxl345->interface.bus_initialize(adxl345->interface.bus_user)
               : ADXL345_ERR_NULL;
}

static adxl345_err_t adxl345_bus_deinitialize(adxl345_t const* adxl345)
{
    return adxl345->interface.bus_deinitialize
               ? adxl345->interface.bus_deinitialize(adxl345->interface.bus_user)
               : ADXL345_ERR_NULL;
}

static adxl345_err_t adxl345_bus_write_data(adxl345_t const* adxl345,
                                            uint8_t address,
                                            uint8_t const* data,
                                            size_t data_size)
{
    return adxl345->interface.bus_write_data
               ? adxl345->interface.bus_write_data(adxl345->interface.bus_user,
                                                   address,
                                                   data,
                                                   data_size)
               : ADXL345_ERR_NULL;
...
static adxl345_err_t adxl345_bus_read_data(adxl345_t const* adxl345,
                                           uint8_t address,
                                           uint8_t* data,
                                           size_t data_size)
{
    return adxl345->interface.bus_read_data
               ? adxl345->interface.bus_read_data(adxl345->interface.bus_user,
                                                  address,
                                                  data,
                                                  data_size)
               : ADXL345_ERR_NULL;
                                 ...
                                 adxl345_interface_t const* interface)
{
    ...
    return adxl345_bus_initialize(adxl345);
}
...
adxl345_err_t adxl345_deinitialize(adxl345_t* adxl345)
{
    ...
    adxl345_err_t err = adxl345_bus_deinitialize(adxl345);
...
adxl345_err_t adxl345_get_devid_reg(adxl345_t const* adxl345, adxl345_devid_reg_t* reg)
{
    ...
    adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_DEVID, &data, sizeof(data));
...
adxl345_err_t adxl345_get_thresh_tap_reg(adxl345_t const* adxl345, adxl345_thresh_tap_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_THRESH_TAP, &data, sizeof(data));
                                         ...
                                         adxl345_thresh_tap_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_OFSX, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_ofsx_reg(adxl345_t const* adxl345, adxl345_ofsx_reg_t* reg)
{
    ...
    adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_OFSX, &data, sizeof(data));
...
adxl345_err_t adxl345_get_ofsy_reg(adxl345_t const* adxl345, adxl345_ofsy_reg_t* reg)
{
    ...
    adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_OFSY, &data, sizeof(data));
...
adxl345_err_t adxl345_set_ofsy_reg(adxl345_t const* adxl345, adxl345_ofsy_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_OFSY, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_ofsz_reg(adxl345_t const* adxl345, adxl345_ofsz_reg_t* reg)
{
    ...
    adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_OFSZ, &data, sizeof(data));
...
adxl345_err_t adxl345_set_ofsz_reg(adxl345_t const* adxl345, adxl345_ofsz_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_OFSZ, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_dur_reg(adxl345_t const* adxl345, adxl345_dur_reg_t* reg)
{
    ...
    adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_DUR, &data, sizeof(data));
...
adxl345_err_t adxl345_set_dur_reg(adxl345_t const* adxl345, adxl345_dur_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_DUR, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_latent_reg(adxl345_t const* adxl345, adxl345_latent_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_LATENT, &data, sizeof(data));
...
adxl345_err_t adxl345_set_latent_reg(adxl345_t const* adxl345, adxl345_latent_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_LATENT, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_window_reg(adxl345_t const* adxl345, adxl345_window_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_WINDOW, &data, sizeof(data));
...
adxl345_err_t adxl345_set_window_reg(adxl345_t const* adxl345, adxl345_window_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_WINDOW, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_thresh_act_reg(adxl345_t const* adxl345, adxl345_thresh_act_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_THRESH_ACT, &data, sizeof(data));
                                         ...
                                         adxl345_thresh_act_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_THRESH_ACT, &data, sizeof(data));
}
                                           ...
                                           adxl345_thresh_inact_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_THRESH_INACT, &data, sizeof(data));
                                           ...
                                           adxl345_thresh_inact_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_THRESH_INACT, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_time_inact_reg(adxl345_t const* adxl345, adxl345_time_inact_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_TIME_INACT, &data, sizeof(data));
                                         ...
                                         adxl345_time_inact_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_TIME_INACT, &data, sizeof(data));
}
                                            ...
                                            adxl345_act_inact_ctl_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_ACT_INACT_CTL, &data, sizeof(data));
                                            ...
                                            adxl345_act_inact_ctl_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_ACT_INACT_CTL, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_thresh_ff_reg(adxl345_t const* adxl345, adxl345_thresh_ff_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_THRESH_FF, &data, sizeof(data));
                                        ...
                                        adxl345_thresh_ff_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_THRESH_FF, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_time_ff_reg(adxl345_t const* adxl345, adxl345_time_ff_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_TIME_FF, &data, sizeof(data));
...
adxl345_err_t adxl345_set_time_ff_reg(adxl345_t const* adxl345, adxl345_time_ff_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_TIME_FF, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_tap_axes_reg(adxl345_t const* adxl345, adxl345_tap_axes_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_TAP_AXES, &data, sizeof(data));
...
adxl345_err_t adxl345_set_tap_axes_reg(adxl345_t const* adxl345, adxl345_tap_axes_reg_t const* reg)
{
    ...
    err |= adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_TAP_AXES, &data, sizeof(data));
                                             ...
                                             adxl345_act_tap_status_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_ACT_TAP_STATUS, &data, sizeof(data));
...
adxl345_err_t adxl345_get_bw_rate_reg(adxl345_t const* adxl345, adxl345_bw_rate_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_BW_RATE, &data, sizeof(data));
...
adxl345_err_t adxl345_set_bw_rate_reg(adxl345_t const* adxl345, adxl345_bw_rate_reg_t const* reg)
{
    ...
    err |= adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_BW_RATE, &data, sizeof(data));
...
adxl345_err_t adxl345_get_power_ctl_reg(adxl345_t const* adxl345, adxl345_power_ctl_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_POWER_CTL, &data, sizeof(data));
                                        ...
                                        adxl345_power_ctl_reg_t const* reg)
{
    ...
    err |= adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_POWER_CTL, &data, sizeof(data));
...
adxl345_err_t adxl345_get_int_enable_reg(adxl345_t const* adxl345, adxl345_int_enable_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_INT_ENABLE, &data, sizeof(data));
                                         ...
                                         adxl345_int_enable_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_INT_ENABLE, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_int_map_reg(adxl345_t const* adxl345, adxl345_int_map_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_INT_MAP, &data, sizeof(data));
...
adxl345_err_t adxl345_set_int_map_reg(adxl345_t const* adxl345, adxl345_int_map_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_INT_MAP, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_int_source_reg(adxl345_t const* adxl345, adxl345_int_source_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_INT_SOURCE, &data, sizeof(data));
                                         ...
                                         adxl345_int_source_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_INT_SOURCE, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_data_format_reg(adxl345_t const* adxl345, adxl345_data_format_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_DATA_FORMAT, &data, sizeof(data));
                                          ...
                                          adxl345_data_format_reg_t const* reg)
{
    ...
    err |= adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_DATA_FORMAT, &data, sizeof(data));
...
adxl345_err_t adxl345_get_data_x_reg(adxl345_t const* adxl345, adxl345_data_x_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_DATA_X0, data, sizeof(data));
...
adxl345_err_t adxl345_get_data_y_reg(adxl345_t const* adxl345, adxl345_data_y_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_DATA_Y0, data, sizeof(data));
...
adxl345_err_t adxl345_get_data_z_reg(adxl345_t const* adxl345, adxl345_data_z_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_DATA_Z0, data, sizeof(data));
...
adxl345_err_t adxl345_get_fifo_ctl_reg(adxl345_t const* adxl345, adxl345_fifo_ctl_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_FIFO_CTL, &data, sizeof(data));
...
adxl345_err_t adxl345_set_fifo_ctl_reg(adxl345_t const* adxl345, adxl345_fifo_ctl_reg_t const* reg)
{
    ...
    return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_FIFO_CTL, &data, sizeof(data));
}
...
adxl345_err_t adxl345_get_fifo_status_reg(adxl345_t const* adxl345, adxl345_fifo_status_reg_t* reg)
{
    ...
    adxl345_err_t err =
        adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_FIFO_STATUS, &data, sizeof(data));
