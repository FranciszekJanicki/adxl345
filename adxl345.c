...
adxl345_err_t adxl345_get_devid_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_DEVID,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_get_thresh_tap_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(
      adxl345, ADXL345_REG_ADDR_THRESH_TAP, &data, sizeof(data));
...
adxl345_err_t adxl345_set_thresh_tap_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_OFSX, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_ofsx_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_OFSX,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_get_ofsy_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_OFSY,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_set_ofsy_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_OFSY, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_ofsz_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_OFSZ,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_set_ofsz_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_OFSZ, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_dur_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err =
      adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_DUR, &data, sizeof(data));
...
adxl345_err_t adxl345_set_dur_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_DUR, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_latent_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_LATENT,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_set_latent_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_LATENT, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_window_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_WINDOW,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_set_window_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_WINDOW, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_thresh_act_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(
      adxl345, ADXL345_REG_ADDR_THRESH_ACT, &data, sizeof(data));
...
adxl345_err_t adxl345_set_thresh_act_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_THRESH_ACT, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_thresh_inact_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(
      adxl345, ADXL345_REG_ADDR_THRESH_INACT, &data, sizeof(data));
...
adxl345_err_t
adxl345_set_thresh_inact_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_THRESH_INACT, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_time_inact_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(
      adxl345, ADXL345_REG_ADDR_TIME_INACT, &data, sizeof(data));
...
adxl345_err_t adxl345_set_time_inact_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_TIME_INACT, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_act_inact_ctl_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(
      adxl345, ADXL345_REG_ADDR_ACT_INACT_CTL, &data, sizeof(data));
...
adxl345_err_t
adxl345_set_act_inact_ctl_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_ACT_INACT_CTL, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_thresh_ff_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_THRESH_FF,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_set_thresh_ff_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_THRESH_FF, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_time_ff_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_TIME_FF,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_set_time_ff_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_TIME_FF, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_tap_axes_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_TAP_AXES,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_set_tap_axes_reg(adxl345_t const *adxl345,
  ...
  err |= adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_TAP_AXES, &data,
                                sizeof(data));
...
adxl345_err_t
adxl345_get_act_tap_status_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(
      adxl345, ADXL345_REG_ADDR_ACT_TAP_STATUS, &data, sizeof(data));
...
adxl345_err_t adxl345_get_bw_rate_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_BW_RATE,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_set_bw_rate_reg(adxl345_t const *adxl345,
  ...
  err |= adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_BW_RATE, &data,
                                sizeof(data));
...
adxl345_err_t adxl345_get_power_ctl_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_POWER_CTL,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_set_power_ctl_reg(adxl345_t const *adxl345,
  ...
  data &=
      ~((0x01U << 5U) | (0x01U << 4U) | (0x01U << 3U) | (0x01U << 2U) | 0x03U);
  ...
  err |= adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_POWER_CTL, &data,
                                sizeof(data));
...
adxl345_err_t adxl345_get_int_enable_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(
      adxl345, ADXL345_REG_ADDR_INT_ENABLE, &data, sizeof(data));
...
adxl345_err_t adxl345_set_int_enable_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_INT_ENABLE, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_int_map_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_INT_MAP,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_set_int_map_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_INT_MAP, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_int_source_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(
      adxl345, ADXL345_REG_ADDR_INT_SOURCE, &data, sizeof(data));
...
adxl345_err_t adxl345_set_int_source_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_INT_SOURCE, &data,
                                sizeof(data));
}

adxl345_err_t adxl345_get_data_format_reg(adxl345_t const *adxl345,
                                          adxl345_data_format_reg_t *reg) {
  assert(adxl345 && reg);

  uint8_t data = {};

  adxl345_err_t err = adxl345_bus_read_data(
      adxl345, ADXL345_REG_ADDR_DATA_FORMAT, &data, sizeof(data));
...
adxl345_err_t
adxl345_set_data_format_reg(adxl345_t const *adxl345,
  ...
  data &= ~((0x01U << 7U) | (0x01U << 6U) | (0x01U << 5U) | (0x01U << 3U) |
            (0x01U << 2U) | 0x03U);
  ...
  err |= adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_DATA_FORMAT, &data,
                                sizeof(data));
...
adxl345_err_t adxl345_get_data_x_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_DATA_X0,
                                            data, sizeof(data));
...
adxl345_err_t adxl345_get_data_y_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_DATA_Y0,
                                            data, sizeof(data));
...
adxl345_err_t adxl345_get_data_z_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_DATA_Z0,
                                            data, sizeof(data));
...
adxl345_err_t adxl345_get_fifo_ctl_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(adxl345, ADXL345_REG_ADDR_FIFO_CTL,
                                            &data, sizeof(data));
...
adxl345_err_t adxl345_set_fifo_ctl_reg(adxl345_t const *adxl345,
  ...
  return adxl345_bus_write_data(adxl345, ADXL345_REG_ADDR_FIFO_CTL, &data,
                                sizeof(data));
}
...
adxl345_err_t adxl345_get_fifo_status_reg(adxl345_t const *adxl345,
  ...
  adxl345_err_t err = adxl345_bus_read_data(
      adxl345, ADXL345_REG_ADDR_FIFO_STATUS, &data, sizeof(data));
