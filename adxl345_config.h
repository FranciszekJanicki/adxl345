...
typedef struct {
    void* bus_user;
    adxl345_err_t (*bus_init)(void*);
    adxl345_err_t (*bus_deinit)(void*);
    adxl345_err_t (*bus_write)(void*, uint8_t, uint8_t const*, size_t);
    adxl345_err_t (*bus_read)(void*, uint8_t, uint8_t*, size_t);
} adxl345_interface_t;
